...
import { DetailHeinz } from '../../assets';
    ...
    <SafeAreaView style={{ flex: 1 }}>
      <ScrollView bounces={false}>
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', marginHorizontal: 28 }}>
          <Image source={DetailHeinz} resizeMode="contain" style={{ width: '100%', marginVertical: 25 }} />
          <View style={{ width: 'auto', backgroundColor: '#6C3428', paddingHorizontal: 20, paddingVertical: 5, borderRadius: 1000, rowGap: 10, marginBottom: 37 }}>
            <Text style={{ textAlign: 'center', fontSize: 20, fontWeight: '600', color: '#fff' }}>Heinz Darell Kristian</Text>
          </View>
          <View style={{ rowGap: 15, paddingHorizontal: 10, paddingVertical: 10, width: '100%', backgroundColor: '#6C3428', borderRadius: 15 }}>
            ...
            <Text style={{ fontSize: 14, fontWeight: '400', textAlign: 'left', color: '#fff' }}>Nickname : roboheinz</Text>
            <Text style={{ fontSize: 14, fontWeight: '400', textAlign: 'left', color: '#fff' }}>Usia : 16 Tahun</Text>
            <View>
